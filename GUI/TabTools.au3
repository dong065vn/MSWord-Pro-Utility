...
Func _CreateTabTools()
    ...
    $g_btnPreviewParentheses = _CreateButton("Preview ngoac ANH", 430, 245, 110, 26)
    GUICtrlSetTip(-1, "Xem truoc cac cum tieng Anh trong ngoac se bi xoa, nhung giu lai citation va viet tat")
    $g_btnRemoveParenthesesSelection = _CreateButton("Xoa ANH vung chon", 545, 245, 95, 26)
    GUICtrlSetTip(-1, "Chi xoa cum tieng Anh trong ngoac o vung chon. Giu lai (2011), (Smith, 2011), (KPI), (KOL)")
    $g_btnRemoveParenthesesText = _CreateButton("Xoa ANH toan file", 645, 245, 95, 26)
    GUICtrlSetTip(-1, "Chi xoa cum tieng Anh trong ngoac tren toan file. Giu lai citation va viet tat")
    _EndGroup()
