...
Func _CreateTabAIFormat()
    ...
    _CreateGroup(" Xu ly nang cao & Lam dep ", 35, 430, 710, 90)
    ...
    $g_btnAIBeautifySettings = _CreateButton("Thiet dat lam dep", 50, 488, 140, 28, 0x34495E)
    $g_btnAISettings = _CreateButton("Cai dat format", 200, 488, 120, 28, 0x34495E)
    _CreateLabel("Don dep -> Xu ly Markdown -> Chuan Format -> Lam dep = Van ban chuan do an", 340, 493, 400, 20)
    _EndGroup()
EndFunc
